...
const REPO_URL = "https://github.com/furrycordoff/furrycord";
...
function UpdaterTab() {
    ...
    return (
        <SettingsTab>
            <Heading className={Margins.top16}>Furrycord Updater</Heading>
            <Paragraph className={Margins.bottom20}>
                Check for new versions of Furrycord. Updates can be installed automatically.
            </Paragraph>
            ...
            <Card style={{ padding: "12px 16px", marginBottom: 12 }}>
                <Flex style={{ alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <div>
                        ...
                        <div>
                            <Link href="https://furrycord.su" style={{ fontSize: 13 }}>
                                furrycord.su
                            </Link>
                        </div>
                    </div>
