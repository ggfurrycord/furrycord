...
import { ContributeModal } from "../../../../furrycord/renderer/components/ContributeModal";
...
const DEV_TEAM = [
    {
        ...
        description: "Founder and owner of Furrycord."
    },
    {
        id: "kza",
        name: "Kza",
        ...
        description: "Co-owner of Furrycord."
    },
    {
        id: "attachante",
        name: "attachante",
        ...
        description: "Developer within the Furrycord team."
    },
    {
        id: "Fancy",
        name: "Fancy",
    ...
    },
    {
        ...
        description: "Bot developer for Furrycord."
    },
    {
        id: "biemal",
        name: "Biemal",
        ...
        description: "WebApp developer within the Furrycord team."
    }
];
    ...
    return (
        <>
            <QuickActionCard>
                ...
                <QuickAction
                    Icon={PlanetIcon}
                    text="Furrycord Server"
                    action={() => window.open("https://discord.gg/furrycord", "_blank")}
                />
            </QuickActionCard>
...
function useStealthActive() {
    ...
    React.useEffect(() => {
        ...
        window.addEventListener("furrycord-stealth-change", handler);
        return () => window.removeEventListener("furrycord-stealth-change", handler);
    }, []);
    return active;
}
    ...
    return (
        <>
            ...
            <Paragraph className={Margins.bottom16}>
                {enabled
                    ? "Stealth mode is enabled — all Furrycord visual elements are hidden. Shortcut: Ctrl+Shift+H"
                    : "Hides all Furrycord visual elements (icons, buttons, context menus) without disabling plugins. Shortcut: Ctrl+Shift+H"}
            </Paragraph>
            <Button
    ...
    return (
        <SettingsTab>
            ...
            {!stealthActive && (<>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Furrycord behaves and integrates with Discord. These settings affect the Discord client's appearance and behavior.
                </Paragraph>
                ...
                <Paragraph className={Margins.bottom16}>
                    Configure how Furrycord handles notifications. You can customize when and how you receive alerts, or view a history of past notifications.
                </Paragraph>
            ...
            <Heading className={Margins.top20}>Stealth Mode</Heading>
            <Paragraph className={Margins.bottom16}>
                Hides all Furrycord visual elements without disabling plugins. Shortcut: Ctrl+Shift+H
            </Paragraph>
            <StealthModeButton />
...
export default wrapTab(EquicordSettings, "Furrycord Settings");
