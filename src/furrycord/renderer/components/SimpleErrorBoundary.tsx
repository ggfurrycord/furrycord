...
import { Card, ErrorBoundary, HeadingTertiary, Paragraph, TextButton } from "@Furrycord/types/components";
import { FluxDispatcher, InviteActions } from "@Furrycord/types/webpack/common";
...
function Fallback() {
    return (
        <Card variant="danger">
            ...
            <Paragraph>
                Please make sure Furrycord and Furrycord are fully up to date. You can get help in our{" "}
