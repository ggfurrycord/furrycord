...
import { Button, Flex, Heading, Paragraph } from "@Furrycord/types/components";
import { ModalContent, ModalFooter, ModalHeader, ModalRoot } from "@Furrycord/types/utils";
            ...
            <ModalContent style={{ padding: "16px 24px" }}>
                <div style={{
                    ...
                    <Paragraph style={{ fontWeight: "bold", marginBottom: "6px", color: "var(--text-normal)" }}>
                        Furrycord is a 100% Free product.
                    </Paragraph>
                    ...
                    <ul style={{ listStyle: "none", padding: 0, margin: 0 }}>
                        ...
                        <li style={{ color: "var(--text-normal)" }}>
                            ...
                            <span
                                ...
                                onClick={() => window.open("https://discord.gg/furrycord", "_blank")}
                            >
                                discord.gg/furrycord
                            </span>
                        </li>
                    </ul>
                </div>
                ...
                <div style={{
                    ...
                    <Paragraph style={{ color: "var(--text-muted)", fontStyle: "italic", fontSize: "13px" }}>
                        <strong>Note:</strong> Only download Furrycord via our official channels to ensure your security.
                    </Paragraph>
                </div>
            </ModalContent>
