...
import { useState } from "@Furrycord/types/webpack/common";
    ...
    return (
        <>
            <VesktopSettingsSwitch
                ...
                description="Automatically start Furrycord on computer start-up"
            ...
            <VesktopSettingsSwitch
                ...
                description={"Start Furrycord minimized when starting with system"}
