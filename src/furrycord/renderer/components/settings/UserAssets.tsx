...
import { BaseText, Button, FormSwitch } from "@Furrycord/types/components";
import {
    Margins,
    ModalCloseButton,
    ModalContent,
...
import { showToast, useState } from "@Furrycord/types/webpack/common";
        ...
        <section>
            ...
            <div className="vcd-user-assets-asset">
                <img
                    ...
                    src={`furrycord://assets/${asset}?v=${version}`}
                    alt=""
