...
import { BaseText } from "@Furrycord/types/components";
import { useState, useRef } from "@Furrycord/types/webpack/common";

import { cl } from "./Settings";

function detectSource(json: any): "equicord" | "vencord" | "furrycord" | "unknown" {
    ...
    // Plugins spécifiques à Furrycord
    if (pluginNames.some(p => ["FurrycordHelper", "equicordHelper"].includes(p))) return "furrycord";
...
function cleanForFurrycord(json: any): any {
    ...
    // Supprimer les plugins propres à Equicord/Vencord qui n'existent pas dans Furrycord
    ...
    async function processFile(file: File) {
        ...
        try {
            ...
            const sourceLabel =
                ...
                source === "furrycord" ? "Furrycord" : "inconnu";

            const cleaned = cleanForFurrycord(json);
            ...
            setStatus("success");
            setMessage(`✅ Settings ${sourceLabel} importés avec succès ! Redémarre Furrycord pour appliquer.`);
        } catch (err: any) {
            setStatus("error");
    ...
    return (
        <div className={cl("category")}>
            ...
            <BaseText size="sm" style={{ marginBottom: "12px", opacity: 0.7 }}>
                Drag & drop your Equicord or Vencord backup JSON file here to import your settings into Furrycord.
                Plugin-specific settings that don't exist in Furrycord will be automatically removed.
            </BaseText>
