...
import { Heading, Paragraph } from "@Furrycord/types/components";
import { Margins } from "@Furrycord/types/utils";
import { Select } from "@Furrycord/types/webpack/common";
            ...
            <SimpleErrorBoundary>
                <Select
                    ...
                    options={[
                        ...
                        {
                            label: "Acrylic (blurs the window behind Furrycord for a translucent background)",
                            value: "acrylic"
                        }
                    ]}
                    closeOnSelect={true}
