...
import { classNameFactory } from "@Furrycord/types/api/Styles";
import { BaseText, Divider, ErrorBoundary } from "@Furrycord/types/components";
...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "Furrycord" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
        ...
        },
        {
            ...
            description:
                "Shows a small splash screen while Furrycord is loading. Disabling this option will show the main window earlier while it's still loading.",
            defaultValue: true
        },
        {
            key: "splashTheming",
    ...
    Behaviour: [
        {
            key: "tray",
            title: "Tray Icon",
            description: "Add a tray icon for Furrycord",
            defaultValue: true,
            invisible: () => isMac
        },
        {
            ...
            description: "Hitting X will make Furrycord minimize to the tray instead of closing",
            defaultValue: true,
            invisible: () => isMac,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the Furrycord window visibility.",
            defaultValue: false
        },
        {
            key: "disableMinSize",
    ...
    Miscellaneous: [
        ...
        },
        {
            ...
            description: "Opens links in a new Furrycord window instead of your web browser",
            defaultValue: false
        }
    ],
...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the Furrycord Settings tab. If this issue persists, try to right click the Furrycord tray icon, then click 'Repair Furrycord'. And make sure your Furrycord is up to date."
    }
);
