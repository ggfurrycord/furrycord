...
import {
    ...
    RestartIcon,
    Span
} from "@Furrycord/types/components";
import {
    closeModal,
    Logger,
    ModalCloseButton,
...
import { FluxDispatcher, MediaEngineStore, Select, UserStore, useState } from "@Furrycord/types/webpack/common";
...
const logger = new Logger("FurrycordScreenShare");
