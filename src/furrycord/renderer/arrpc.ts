...
import { Logger } from "@Furrycord/types/utils";
import { findLazy, onceReady } from "@Furrycord/types/webpack";
import {
    ...
    InviteActions,
    StreamerModeStore
} from "@Furrycord/types/webpack/common";
import { IpcCommands } from "shared/IpcEvents";

import { onIpcCommand } from "./ipcCommands";

const logger = new Logger("FurrycordRPC", "#5865f2");
