...
export async function downloadVencordAsar() {
    await downloadFile(
        "https://github.com/Furrycord/Furrycord/releases/latest/download/Furrycord.asar",
        VENCORD_DIR,
        {},
...
export function isValidVencordInstall(dir: string) {
    return existsSync(join(dir, "Furrycord/main.js"));
}

export async function ensureVencordFiles() {
    if (!existsSync(VENCORD_DIR)) {
        console.error("Bundled furrycord.asar not found at", VENCORD_DIR);
    }
}
