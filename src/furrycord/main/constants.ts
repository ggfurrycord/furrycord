...
const FurrycordDir = dirname(process.execPath);

export const PORTABLE =
    process.platform === "win32" &&
    !process.execPath.toLowerCase().endsWith("electron.exe") &&
    !existsSync(join(FurrycordDir, "Uninstall Furrycord.exe"));

export const DATA_DIR =
    process.env.Furrycord_USER_DATA_DIR || (PORTABLE ? join(FurrycordDir, "Data") : join(app.getPath("userData")));
...
export const USER_AGENT = `Furrycord/${app.getVersion()} (https://github.com/Furrycord/Furrycord)`;
