...
export const enum IpcEvents {
    ...
    SET_WINDOW_BACKGROUND_MATERIAL = "FurrycordSetWindowBackgroundMaterial",
    ...
    // Furrycord Updater — télécharge un exe depuis une URL et le lance
    FURRYCORD_DOWNLOAD_AND_RUN = "FurrycordDownloadAndRun",

    // VB-Audio Virtual Cable (Windows only)
    CHECK_VB_CABLE = "FurrycordCheckVBCable",
    INSTALL_VB_CABLE = "FurrycordInstallVBCable",

    // Relaunch de l'app Electron
    RELAUNCH_APP = "FurrycordRelaunchApp",
