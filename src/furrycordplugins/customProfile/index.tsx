...
const LS_KEY_DATA = "FurrycordCP_data";
const LS_KEY_ENABLED = "FurrycordCP_enabled";
const DS_ALL_DATA = "customProfile_allData";
const DS_ALL_ENABLED = "customProfile_allEnabled";
const LS_ALL_DATA = "FurrycordCP_allData";
const LS_ALL_ENABLED = "FurrycordCP_allEnabled";
