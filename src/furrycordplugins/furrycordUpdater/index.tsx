...
const REMOTE_VERSION_URL =
    "https://api.github.com/repos/furrycordoff/furrycord-macos/releases/latest";
...
async function checkForUpdates() {
    try {
        ...
        console.log(`[FurrycordUpdater] local=${localVersion} remote=${remoteVersion}`);
        ...
        console.error("[FurrycordUpdater] Error vérification:", e);
    }
}
...
function UpdateBanner() {
    ...
    function doUpdate() {
        ...
        window.open("https://furrycord.su", "_blank");
    ...
    return React.createElement("div", {
        ...
        React.createElement("div", {
            ...
            React.createElement("span", { style: { fontWeight: 700, flexShrink: 0 } },
                `🔔 Furrycord ${info.remoteVersion} available!`
            ),
...
function mountBanner() {
    if (bannerContainer || document.getElementById("furrycord-updater-root")) return;
    bannerContainer = document.createElement("div");
    bannerContainer.id = "furrycord-updater-root";
    ...
    try {
        ...
        console.error("[FurrycordUpdater] Error montage bannière:", e);
    }
}
