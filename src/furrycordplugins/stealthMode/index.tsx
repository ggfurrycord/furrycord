...
export default definePlugin({
    ...
    description: "Hides all plugin buttons without disabling them. Shortcut: Ctrl+Shift+H. The toggle is in Furrycord Settings.",
    ...
    stop() {
        document.body.classList.remove("furrycord-stealth");
    },
});
