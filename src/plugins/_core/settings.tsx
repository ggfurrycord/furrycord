...
import { CreateThemeTab } from "@furrycordplugins/createTheme/components/CreateThemeTab";
import { PencilSparkleIcon } from "@furrycordplugins/createTheme/components/PencilSparkleIcon";
import IconsTab from "@furrycordplugins/iconViewer/components/IconsTab";
...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the Furrycord settings section",
        options: [
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        const equicordSection: SettingsLayoutNode = {
            ...
            useTitle: () => {
                try { if (localStorage.getItem("Furrycord_stealthMode") === "1") return ""; } catch { }
                return "Furrycord Settings";
            },
            buildLayout: () => {
                try { if (localStorage.getItem("Furrycord_stealthMode") === "1") return [mainEntry]; } catch { }
                return fullEntries;
            }
        };
    ...
    getInfoRows() {
        ...
        const rows = [`Furrycord ${gitHashShort}${getVersionInfo()}`];
