...
let FurrycordBadges = {} as Record<string, Array<Record<"tooltip" | "badge", string>>>;
...
async function loadAllBadges(noCache = false) {
    ...
    const furrycordBadges = await loadBadges("https://api.furrycord.su/badges", noCache).catch(() => ({}));

    DonorBadges = vencordBadges;
    EquicordDonorBadges = equicordBadges;
    FurrycordBadges = furrycordBadges;
}
...
export default definePlugin({
    ...
    getFurrycordBadges(userId: string) {
        try {
            const userBadges = FurrycordBadges[userId];
            ...
            for (const badge of userBadges) {
                ...
                results.push({
                    iconSrc: iconSrc,
                    description: (badge as any).tooltip || (badge as any).description || (badge as any).label || "Furrycord Badge",
