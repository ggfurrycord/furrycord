# ==============================================================================
#  Furrycord — Désinstalleur utilisateur (PowerShell)
#  Supprime l'injection Furrycord de Discord
#
...
Write-Host "  ║      FURRYCORD — Désinstalleur           ║" -ForegroundColor Cyan
Write-Host "  ╚══════════════════════════════════════════╝" -ForegroundColor Cyan
Write-Host ""
...
Write-Host "  │  Furrycord désinstallé avec succès !                 │" -ForegroundColor Green
