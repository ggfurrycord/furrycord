# ==============================================================================
#  Furrycord — Script d'injection Post-Installation
#  Utilisé par l'installateur Inno Setup pour injecter Furrycord dans Discord.
# ==============================================================================
...
# On pointe vers le patcher.js dans le dossier d'installation de Furrycord
$FurrycordPatcher = Join-Path $AppDir "dist\desktop\patcher.js"
$FurrycordPatcher = $FurrycordPatcher.Replace("\", "\\")
...
// Injection Furrycord
try {
    require(\"$FurrycordPatcher\");
} catch (e) {
    console.error(\"Furrycord injection failed:\", e);
