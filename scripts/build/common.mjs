...
function resolveGitHash() {
    if (process.env.FURRYCORD_HASH) return process.env.FURRYCORD_HASH;
    try {
...
export const globPlugins = kind => ({
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "import-plugins" }, async () => {
            const pluginDirs = ["plugins/_api", "plugins/_core", "plugins", "userplugins", "furrycordplugins", "furrycordplugins/_api"];
            let code = "";
            let pluginsCode = "\n";
            let metaCode = "\n";
            let excludedCode = "\n";
...
export const gitRemotePlugin = {
    ...
    setup: build => {
        ...
        build.onLoad({ filter, namespace: "git-remote" }, async () => {
            let remote = process.env.FURRYCORD_REMOTE;
            if (!remote) {
                try {
...
export const commonOpts = {
    ...
    alias: {
        ...
        "@furrycordplugins": "./src/furrycordplugins",
    }
};
