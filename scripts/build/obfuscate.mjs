// @ts-check
/*
 * Furrycord — Post-build obfuscation
...
// ─── Fichiers ciblés ────────────────────────────────────────────────────────
// dist/js/   → buildDesktop (app Furrycord elle-même)
...
// dist/desktop/ et dist/furrycord/ → build.mjs (asar vencord)
const ASAR_JS_FILES = [
    "patcher.js",
    "preload.js",
    "renderer.js",
 ...
 * @param {string} dir  ex: "dist/desktop" ou "dist/furrycord"
 */
